...
type mockMemoryRepo struct {
	...
	findActiveByTopicKeyFn  func(ctx context.Context, scope shared.Scope, topicKey string) (*memory.MemoryRecord, error)
...
func (m *mockMemoryRepo) FindActiveByTopicKey(ctx context.Context, scope shared.Scope, topicKey string) (*memory.MemoryRecord, error) {
	if m.findActiveByTopicKeyFn != nil {
		return m.findActiveByTopicKeyFn(ctx, scope, topicKey)
	}
	return nil, shared.ErrNotFound
}
